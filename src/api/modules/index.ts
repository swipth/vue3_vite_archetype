...
export const ajaxGet = (url: string, params = {}) =>
  ajax({ baseURL: import.meta.env.VUE_APP_CONFERENCE_API, method: "GET", url, params });

export const ajaxDelete = (url: string, params = {}, data = {}) =>
  ajax({ baseURL: import.meta.env.VUE_APP_CONFERENCE_API, method: "DELETE", url, params, data });
